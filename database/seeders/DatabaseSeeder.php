...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \App\Models\Platform::firstOrCreate(['title'=>'SourcePort: GZDad', 'description'=>'One of the two most popular SourcePorts of the PC release, improves stability and supports 64-bit Operating Systems.']);
        \App\Models\Platform::firstOrCreate(['title'=>'SourcePort: DadSpasm', 'description'=>'Second most popular SourcePort, improves stability and allows for easy modification by devs and modders.']);
        \App\Models\Platform::firstOrCreate(['title'=>'Gamecube', 'description'=>'Original Release, considered universally to be the most stable release. This version is also the most canonically accurate.']);
        \App\Models\Platform::firstOrCreate(['title'=>'SNES', 'description'=>'Port of Gamecube release, backwards compatible due to the game releasing between console generations.']);
        \App\Models\Platform::firstOrCreate(['title'=>'Playstation 2', 'description'=>'PS2 Port of XBox release.']);
        \App\Models\Platform::firstOrCreate(['title'=>'XBox', 'description'=>'This platform was very popular at launch, but due to instability and framerate issues, this version performs poorly in speedruns.']);
        \App\Models\Platform::firstOrCreate(['title'=>'Wii', 'description'=>'Port of Gamecube Release.']);
        \App\Models\Platform::firstOrCreate(['title'=>'Nintendo 64', 'description'=>'Original Release, backwards compatible due to the game releasing between console generations.']);
        \App\Models\Platform::firstOrCreate(['title'=>'Smart Fridge', 'description'=>'People say American Dad can run on anything, and this platform proves it. The SourcePort DadSpasm has been heavily modded to support a smart fridge\'s hardware.']);
        \App\Models\Platform::firstOrCreate(['title'=>'3DS', 'description'=>'For the game\'s 5 year anniversary, the devs ported it to the 3DS to be enjoyed on the go.']);
        \App\Models\Platform::firstOrCreate(['title'=>'Game and Watch', 'description'=>'Primitive precursor to the 2005 release.']);
