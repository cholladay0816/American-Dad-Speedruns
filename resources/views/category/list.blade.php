<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-3 gap-5 py-10 text-black">
        ...
        @foreach($categories as $category)
            <div class="motion-reduce:transition-none motion-reduce:transform-none transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 max-w-sm rounded overflow-hidden shadow-lg bg-white grid grid-cols-2 py-3">
