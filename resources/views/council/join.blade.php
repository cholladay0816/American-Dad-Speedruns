<x-app-layout>
    ...
    <form
        ...
        <p class="pb-4">Become a member of the official American Dad Speedrunning Council for <span class="text-green-500">$4.99</span>/mo and decide the fate of every speedrun submitted.
