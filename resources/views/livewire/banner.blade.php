@if(!is_null($banner))
    <div class=" {{!is_null($banner)?'':'hidden'}} bg-{{$banner->bcolor}} text-{{$banner->tcolor}}
        flex flex-row px-4 py-2 mt-4 max-w-5xl rounded-2xl mx-auto text-center text-2xl font-semibold">
